...
import com.bikulwon.manseryeok.adapter.userlist.group.UserGroupCheckBoxAdapter
import com.bikulwon.manseryeok.adapter.userlist.tag.UserTagListAdapter
import com.bikulwon.manseryeok.databinding.ActivityGroupBinding
...
class GroupActivity : ParentActivity() {
    ...
    private fun userinfoSetting() = with(binding) {
        ...
        val username = "${userModel.name} ($birth)"
